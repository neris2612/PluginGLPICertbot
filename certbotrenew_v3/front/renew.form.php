...
echo "<h2>" . __('RenovaÃ§Ã£o de Certificados SSL', 'certbotrenew') . "</h2>";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
   $output = [];
   exec('sudo /usr/bin/certbot renew --dry-run 2>&1', $output, $return_code);

   if ($return_code === 0) {
      echo "<div class='alert alert-success'>";
      echo "<i class='fas fa-check-circle'></i> " . __('RenovaÃ§Ã£o concluÃ­da com sucesso!', 'certbotrenew');
      echo "</div>";
   } else {
